...
export const Tarefa = styled.div`
    ...
    background-image: url('file:///src/components/menu/components/img/tarefa.png');
    visibility: visible;
    -webkit-transform: rotate(-60deg);
    -moz-transform: rotate(-60deg);
    -ms-transform: rotate(-60deg);
...
export const Clientes = styled.div`
    ...
    background-repeat: no-repeat;
    background-position: 50%;
    background-image: url('file:///src/components/menu/components/img/clientes.png');
    visibility: visible;
    -webkit-transform: rotate(-60deg);
    -moz-transform: rotate(-60deg);
    -ms-transform: rotate(-60deg);
...
background-repeat: no-repeat;
background-position: 50%;
background-image: url('file:///src/components/menu/components/img/classificacao.png');
visibility: visible;
-webkit-transform: rotate(-60deg);
-moz-transform: rotate(-60deg);
-ms-transform: rotate(-60deg);
...
export const Setor = styled.div`
    ...
    background-repeat: no-repeat;
    background-position: 50%;
    background-image: url('file:///src/components/menu/components/img/setor.png');
    visibility: visible;
    -webkit-transform: rotate(-60deg);
    -moz-transform: rotate(-60deg);
    -ms-transform: rotate(-60deg);
